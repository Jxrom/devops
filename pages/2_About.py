...
page = st.sidebar.selectbox("Select a page:", ["About", "Classification"])

if page == "About":
    st.set_page_config(page_title="About Page", page_icon="ℹ️")
    ...
    # Add any content specific to the About page here.
else:
